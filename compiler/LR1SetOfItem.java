 ...
 * @author kashin
 */
public class LR1SetOfItem extends SetOfItem {
    ...
    public static LR1SetOfItem of(int id, LR1Item ... items) {
        LR1SetOfItem result = new LR1SetOfItem();
        result.id = id;
    ...
    public static LR1SetOfItem of(LR1SetOfItem setOfItem) {
        LR1SetOfItem result = new LR1SetOfItem();
    ...
    public static LR1SetOfItem of(SetOfItem lr0Set, Terminal lookForward) {
        LR1SetOfItem result = new LR1SetOfItem();
        result.id = lr0Set.id;
    ...
    public boolean equals(Object o) {
        ...
        LR1SetOfItem that = (LR1SetOfItem) o;
